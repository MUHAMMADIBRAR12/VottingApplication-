...
<head>
    ...
    <title>event || Polimark || Polimark Form HTML Template</title>
    ...
    <div class="page-wrapper">
        ...
        <section class="event_page">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="event_page_single">
                            <div class="event_pate_img">
                                <img src="assets/images/event/event-page-img-1.jpg" alt="">
                                <div class="event_page_date_box">
                                    <h4>23</h4>
                                    <span>Dec</span>
                                </div>
                            </div>
                            <div class="event_page_content">
                                <div class="event_page_content_title">
                                    <h4>Election Campaign</h4>
                                    <h3><a href="event-details.html">When the music’s over turn off the light Says Jim
                                            Morisson</a></h3>
                                </div>
                                ...
                                <ul class="event_page_time_location list-unstyled">
                                    <li><i class="far fa-clock"></i>10.00 am</li>
                                    <li><i class="icon-005-pin"></i>New York</li>
                                </ul>
                                <div class="event_page_btn top_section_one_preface_btn">
                                    <a href="event-details.html" class="thm-btn">View Details<i
                                            class="fa fa-angle-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="event_page_single">
                            ...
                            <div class="event_page_content">
                                <div class="event_page_content_title">
                                    <h4>Election Campaign</h4>
                                    <h3><a href="event-details.html">Tobe bondhu nouka virao muchhiye dibo dukkho
                                            betha</a></h3>
                                </div>
                                <div class="event_page_text">
                                    <p>Kobimet, consectetur adipisicing elit, sed do eiusmod te tomader majhe ki keu ase
                        ...
                        <div class="event_page_single">
                            ...
                            <div class="event_page_content">
                                <div class="event_page_content_title">
                                    <h4>Election Campaign</h4>
                                    <h3><a href="event-details.html">Jantrik nogore ekhon majh rate periye gecche nishi
                                            daka </a></h3>
                                </div>
                                <div class="event_page_text">
                                    <p>Kobimet, consectetur adipisicing elit, sed do eiusmod te tomader majhe ki keu ase
                        ...
                        <div class="event_page_single">
                            ...
                            <div class="event_page_content">
                                <div class="event_page_content_title">
                                    <h4>Election Campaign</h4>
                                    <h3><a href="event-details.html">Projapoti ar prohorir hushiari ami ek nogor
                                            baul</a></h3>
                                </div>
                                <div class="event_page_text">
                                    <p>Kobimet, consectetur adipisicing elit, sed do eiusmod te tomader majhe ki keu ase
                        ...
                        <div class="event_page_single">
                            ...
                            <div class="event_page_content">
                                <div class="event_page_content_title">
                                    <h4>Election Campaign</h4>
                                    <h3><a href="event-details.html">Humayrar nishshas churi hoye gese bo hudin dhore
                                            ami</a></h3>
                                </div>
                                <div class="event_page_text">
                                    <p>Kobimet, consectetur adipisicing elit, sed do eiusmod te tomader majhe ki keu ase
