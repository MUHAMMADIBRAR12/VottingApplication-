            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="city_add.php">
                <div class="form-group">
                    ...
                    <div class="col-lg-11">
                      <input type="text"  pattern="[a-zA-Z a-zA-Z]*" class="form-control" id="city_name" name="city_name" required>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="city_edit.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-11">
                      <input type="text" class="form-control"  pattern="[a-zA-Z a-zA-Z]*" id="edit_city_name" name="city_name">
                    </div>
                </div>
                <div class="form-group">
