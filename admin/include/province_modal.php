            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="province_add.php">
                <div class="form-group">
                    ...
                    <div class="col-lg-11">
                      <input type="text" class="form-control" pattern="[a-zA-Z a-zA-Z]*" id="province_name" name="province_name" required>
                    </div>
                </div>
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="province_edit.php" enctype="multipart">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-11">
                      <input type="text" class="form-control" pattern="[a-zA-Z a-zA-Z]*" id="edit_province_name" name="province_name">
                    </div>
                </div>
                            </div>
            <div class="modal-footer">
