            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="nationalseats_add.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-11">
                      <select name='provinceadd'class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-11">
                      <select name='cityadd'class="form-control" required>
                        <option>PLEASE SELECT</option>
                        <?php 
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-11">
                      <input type="text" class="form-control" id="tahseal" name="tahseal" required>
                    </div>
                </div>
