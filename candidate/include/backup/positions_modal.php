            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="positions_add.php">
                <div class="form-group">
                    <label for="description" class="col-sm-7 control-label">Description</label>
                ...
                <div class="form-group">
                    <label for="max_vote" class="col-sm-7 control-label">Maximum Vote</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="positions_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_description" class="col-sm-7 control-label">Description</label>
                ...
                <div class="form-group">
                    <label for="edit_max_vote" class="col-sm-7 control-label">Maximum Vote</label>
