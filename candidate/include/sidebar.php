  <aside class="main-sidebar sidebar-dark-primary elevation-4">
   ...
   <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="dist/img/jpg" class="img-circle elevation-2" alt="">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="candidates.php" class="nav-link">
              ...
              <p>
               Add NA Candidates 
                <span class="right badge badge-warning"> National</span>
              </p>
            </a>
          </li>
          <li class="nav-item">
            <a href="prov_candidate.php" class="nav-link">
              <i class="nav-icon fas fa-id-badge "></i>
              <p>
               Add PA Candidates
                <span class="right badge badge-danger">Prov</span>
              </p>
            </a>
          </li><!-- 
