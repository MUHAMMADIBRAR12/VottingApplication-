        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                    <label for="city" class="col-sm-7 control-label">NA SEAT</label>
                    <div class="col-lg-12">
                      <select name='seatno'class="form-control" required>
                        <option>PLEASE SELECT</option>
                        <?php 
                      $select="select * from national_seats";
                      $select=mysqli_query($conn,$select);
                      while($row=mysqli_fetch_assoc($select)){
                      ?>
                         <option value='<?php echo $row['na_id'];?>'>NA <?php echo $row['seat_number']?></option>
                       <?php 
                     }
                   ?>
                      </select>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="platform" class="col-sm-7 control-label">platform</label>
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_edit.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-11">
                      <input type="text"   pattern="[a-zA-Z]*"class="form-control" id="edit_lastname" name="lastname">
                    </div>
                </div>
                 <div class="form-group">
