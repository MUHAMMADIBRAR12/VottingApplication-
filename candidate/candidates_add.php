...
session_start();
	...
	if(isset($_POST['add'])){
		...
		$sql = "INSERT INTO  candidates(firstname,lastname,platform,cnic,ph_number,email,photo,status,seat_id,partie_id,type) VALUES ('$firstname','$lastname','$platform','$cnic','$ph_number','$email','$img_new','1','$seatno','$partie_id','0')";
				if($conn->query($sql)){
